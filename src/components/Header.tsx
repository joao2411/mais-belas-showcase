    ...
    <div className="container mx-auto px-4">
      <div className="flex items-center justify-between h-20">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <a href="tel:+5561998239811" className="flex items-center gap-2 text-sm text-foreground/70 hover:text-primary transition-colors">
            <Phone className="w-4 h-4" />
            (61) 99823-9811
          </a>
          <Button variant="hero" size="lg" asChild>
            <a href="https://wa.me/5561998239811" target="_blank" rel="noopener noreferrer" className="gap-2">
